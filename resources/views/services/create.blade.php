    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Tambah layanan baru yang tersedia</p>
            </div>
        </div>
            ...
            <form action="{{ route('services.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name"
                        ...
                        value="{{ old('name') }}" placeholder="Nama layanan" required>
                    @error('name')
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        ...
                        placeholder="Deskripsi singkat layanan (opsional)">{{ old('description') }}</textarea>
                </div>
