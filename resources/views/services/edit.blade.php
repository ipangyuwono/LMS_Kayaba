    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Perbarui detail layanan</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <form action="{{ route('services.update', $service) }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1.5">Nama Layanan <span class="text-pink-500">*</span></label>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-400 text-sm transition resize-none">{{ old('description', $service->description) }}</textarea>
                </div>
