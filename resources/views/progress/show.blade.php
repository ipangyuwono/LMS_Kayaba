...
<body class="bg-[#F3F2EC] font-['Manrope',sans-serif]">
    <div class="flex min-h-screen relative overflow-visible">
        ...
        <main
            ...
            {{-- Header Bar --}}
            <div
                class="bg-white rounded-xl shadow-lg border border-gray-200/60 p-6 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="w-16 h-16 relative">
                        <svg class="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                            <circle cx="18" cy="18" r="14" fill="none" stroke="#f1f1f1"
                                stroke-width="3" />
                            <circle cx="18" cy="18" r="14" fill="none" stroke="#E62727"
                                stroke-width="3" stroke-dasharray="{{ $pct * 0.88 }} 88" stroke-linecap="round"
                ...
                <section
                    ...
                    <div
                        ...
                        <div class="ml-auto">
                            ...
                            @endif
                            <span class="text-xs font-semibold text-gray-400">{{ $svcCompleted }}/{{ $mats->count() }}</span>
                        </div>
                    </div>
            ...
            @if ($materials->isEmpty())
                <div class="bg-white rounded-xl shadow-lg p-12 text-center border border-gray-200/60">
                    ...
                    <a href="{{ route('materials.index') }}"
                        class="inline-block mt-3 text-sm font-bold text-[#E62727] hover:underline">Tambah materi →</a>
                </div>
            @endif
        </main>
    </div>
